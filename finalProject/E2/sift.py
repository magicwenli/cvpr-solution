...
def merge_images(img1, img2):
    ...
    # 对右边的图片进行变换，得到变换后的图像
    img_out = cv.warpPerspective(img2, H, (x_out + 300, y_out))
...
for i in range(1, k + 1):
    img.append(cv.imread("/Users/dy/PycharmProjects/cv_exp/sift/camera/" + str(i) + ".jpg"))
    print(img[i])
...
# img35 = cv.imread("/Users/dy/PycharmProjects/cv_exp/sift/image/result3-5.png")
# img = merge_images(img[2],img35)
# cv.imwrite('/Users/dy/PycharmProjects/cv_exp/sift/image/result2-5.png', img)
