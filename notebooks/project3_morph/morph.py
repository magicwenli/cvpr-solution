...
def morph(img_src, img_dst, s_points, d_points, percent=0.5):
    shape = img_src.shape
    result_points = weighted_average_points(s_points, img_dst, percent)
...
if __name__ == '__main__':
    img_1 = cv2.imread('Gollum/a.png')
    img_2 = cv2.imread('Gollum/b.png')
    ...
    for i in np.linspace(0, 1, 20, True):
